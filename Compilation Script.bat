...
g++ -s minecraft_seed_converter.cpp -oSeed_Converter_O3 -O3
g++ -s minecraft_seed_converter.cpp -oSeed_Converter_Os -Os
g++ -s minecraft_seed_converter.cpp -oSeed_Converter_Ofast -Ofast
